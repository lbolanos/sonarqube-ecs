...
COPY --chown=sonarqube:sonarqube run.sh sonar.sh vm.sh ${SONARQUBE_HOME}/bin/
...
COPY --chown=sonarqube:sonarqube plugins/sonarqube-community-branch-plugin-${PLUGIN_VERSION}.jar /opt/sonarqube/extensions/plugins/
